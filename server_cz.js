...
async function RunHubspotPDFCreation() {
    ...
    await axios.get(tableRowsUrl).then(async(result) => {
        ...
        for (var i = 0; i < productRows.length; i++) {
            ...
            // Build template url
            var templateUrl = `https://lichtline.com/datový-list/${path}`;
            ...
            var fileName = `datový-list-${path}.pdf`;
            var pathToFile = `./files_cz/datový-list-${path}.pdf`
            ...
            var formData = {
                ...
                folderPath: 'Homepage/Datenblaetter_CZ'
            };
            ...
            // Friendly File URL
            var friendlyFileURL = `https://f.hubspotusercontent40.net/hubfs/7712640/Homepage/Datenblaetter_CZ/${fileName}`;
