...
async function RunHubspotPDFCreation() {
    ...
    await axios.get(tableRowsUrl).then(async(result) => {
        ...
        for (var i = 0; i < productRows.length; i++) {
            ...
            // Build template url
            var templateUrl = `https://lichtline.com/datasheet/${path}`;
            ...
            var fileName = `datasheet-${path}.pdf`;
            var pathToFile = `./files_en_ll/datasheet-${path}.pdf`
            ...
            var formData = {
                ...
                folderPath: 'Homepage/Datenblaetter_EN_LL'
            };
            ...
            // Friendly File URL
            var friendlyFileURL = `https://f.hubspotusercontent40.net/hubfs/7712640/Homepage/Datenblaetter_EN_LL/${fileName}`;
