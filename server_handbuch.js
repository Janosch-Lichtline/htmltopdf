...
async function RunHubspotPDFCreation() {
    ...
    await axios.get(tableRowsUrl).then(async(result) => {
        ...
        for (var i = 0; i < productRows.length; i++) {
            ...
            // Build template url
            var templateUrl = `https://lichtline.com/produkthandbuch/${path}`;
            ...
            var fileName = `produkthandbuch-${path}.pdf`;
            var pathToFile = `./files_produkthandbuch/produkthandbuch-${path}.pdf`
            ...
            var formData = {
                ...
                folderPath: 'Homepage/Produkthandbuecher'
            };
            ...
            // Friendly File URL
            var friendlyFileURL = `https://f.hubspotusercontent40.net/hubfs/7712640/Homepage/Produkthandbuecher/${fileName}`;
